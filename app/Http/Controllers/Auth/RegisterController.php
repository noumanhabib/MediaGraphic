    ...
    */
    ...
    protected function create(array $data)
    {
        return User::create([
            ...
            'shiping_address' => isset($data['address']) ? $data['address'] : null,
            'shiping_postal' => isset($data['postal']) ? $data['postal'] : null,
            'shiping_city' => isset($data['city']) ? $data['city'] : null,
            'billing_address' => isset($data['billing_address']) ? $data['billing_address'] : null,
            'billing_postal' => isset($data['billing_postal']) ? $data['billing_postal'] : null,
